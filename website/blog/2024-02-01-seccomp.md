...
-   gVisor generates a sequence of rulesets from this configuration. A ruleset
    ...
    [in gVisor code](https://github.com/relkochta/gvisor/blob/master/runsc/boot/filter/config/config_main.go)
    as follows:
...
[bytecode-level cBPF optimizer](https://github.com/relkochta/gvisor/blob/master/pkg/bpf/optimizer.go)
...
performs
[`seccomp` ruleset optimizations](https://github.com/relkochta/gvisor/blob/master/pkg/seccomp/seccomp_optimizer.go).
...
In the
[gVisor Sentry `seccomp-bpf` configuration](https://github.com/relkochta/gvisor/blob/master/runsc/boot/filter/config/),
...
So now gVisor has
[tooling for benchmarking `seccomp-bpf` programs](https://github.com/relkochta/gvisor/blob/master/test/secbench/).
It works by taking a
[cBPF program along with several possible syscalls](https://github.com/relkochta/gvisor/blob/master/runsc/boot/filter/filter_bench_test.go)
...
gVisor also has
[`seccomp-bpf` fuzz tests](https://github.com/relkochta/gvisor/blob/master/test/secfuzz/).

Because gVisor knows which high-level filters went into constructing the
`seccomp-bpf` program, it also
[automatically generates test cases](https://github.com/relkochta/gvisor/blob/master/runsc/boot/filter/filter_fuzz_test.go)
...
themselves, and
[implements its own cBPF interpreter](https://github.com/relkochta/gvisor/blob/master/pkg/bpf/interpreter.go)
for this purpose.
...
[precompiles the rules](https://github.com/relkochta/gvisor/blob/master/pkg/seccomp/precompiledseccomp/)
